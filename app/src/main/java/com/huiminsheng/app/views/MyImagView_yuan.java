 ...
 * @author zhangqie
 */
public class MyImagView_yuan extends android.support.v7.widget.AppCompatImageView {
    ...
    private int mType = 0;// 记录是圆形还是圆角矩形【手动设置】
    ...
    public MyImagView_yuan(Context context) {
        this(context, null);
        // TODO Auto-generated constructor stub
    }

    public MyImagView_yuan(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // TODO Auto-generated constructor stub
    }

    public MyImagView_yuan(Context context, AttributeSet attrs, int defStyle) {
