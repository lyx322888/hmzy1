...
//商品列表
public class MyorderAdapterInformation extends BaseQuickAdapter<BeanMyOrder.DataBean.ListBeanX.ListBean, BaseViewHolder> {

    public MyorderAdapterInformation(int layoutResId, @Nullable List<BeanMyOrder.DataBean.ListBeanX.ListBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, BeanMyOrder.DataBean.ListBeanX.ListBean item) {
