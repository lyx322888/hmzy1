package com.huiminsheng.app.utils.statusbar;
...
public final class BarUtils {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        if (isFlyme()) {
            ...
            activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, 0, 0, BarUtils.navigationHeight);
        }
    }
...
//            tintManager.setStatusBarTintResource(colorId);
    ...
    public static void StatusBarLightMode(Activity activity, int type){
        if(type==1){
            boolean b = MIUISetStatusBarLightMode(activity, true);
            Logger.d("StatusBarLightMode" + b);
        }else if(type==2){
