...
public class ExpandableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private static final int MAX_LINES_ON_SHRINK = 2;//默认行数
    private static final int TO_EXPAND_HINT_COLOR = 0xFF396BFF;
    private static final int TO_SHRINK_HINT_COLOR = 0xFF396BFF;
