...
/**
 * 请求回调封装  返回所有情况的回调 除异地
 * @author Lyx
 * @date 2017/11/17
 */

public  class BaseResponseListenerString<T> implements OnResponseListener<Result<T>> {
     ...
     */
    BaseResponseListenerString(Context context, boolean isShowDiaog, BaseListener<T> listener, MyRestRequest<T> myRestRequest) {
